...
internal static class ShellOperationInvoker
{
    ...
    public static IAutomationModule CreateModule(IPwshShellService service)
    {
        ...
        return new ReflectionShellModule(
    ...
    private sealed class ReflectionShellModule(
        string id,
        ...
        MethodInfo method) : IAutomationModule
    {
        ...
        public Task<ModuleExecutionResult> ExecuteAsync(ModuleExecutionContext context)
        {
            ...
            return Task.FromResult(new ModuleExecutionResult(SerializeResult(result)));
        }
