# NAutomate Documentation

This directory documents architecture and development conventions for NAutomate and its coding agents.

## Documents

- [Architecture](architecture.md) — solution responsibilities and dependency boundaries.
...
Agent-specific reusable guidance is in `.github/skills/`.
